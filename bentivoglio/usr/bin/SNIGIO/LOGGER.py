...
class messages:
    ...
    def gray_logger_SATS(MSG, MQTYPE):
        import SNIGIO.my_global as var_g
        var_g.logger.debug('\"Frame_time:test\" - \"MQTYPE:%s\" - \"SedeDHL:%s\" - \"Message:%s\" - \"MQDEBUG:%s\" - \"CLI_DEBUG:%s\"', MQTYPE, var_g.SedeDHL, MSG, var_g.MQDEBUG, var_g.CLI_DEBUG)
